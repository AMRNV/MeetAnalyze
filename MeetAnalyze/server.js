 ...
 * transcribes audio/video via Claude AI, analyzes the transcript with Claude,
 * and returns a structured summary with key decisions and action items.
 * Results can be exported as PDF or DOCX.
 *
 * Environment variables (set in .env):
 *   ANTHROPIC_API_KEY  — Anthropic API key for Claude (transcription + analysis)
...
import { analyzeWithClaude, transcribeAndAnalyzeWithClaude } from './lib/analyze.js';
import { readTextFile } from './lib/transcript.js';
import { streamPDF, buildDOCX } from './lib/export.js';
